    ...
    <div className="min-h-screen bg-[#fafafa] overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 overflow-hidden">
          ...
          <div className="absolute bottom-[10%] right-[-5%] w-[30%] h-[30%] bg-indigo-100/50 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-sm font-semibold mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <Activity className="w-4 h-4" />
            <span>Trusted by 10,000+ patients</span>
          </div>
          
          <h1 className="text-5xl lg:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
            Healthcare Designed for <br />
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Modern Living</span>
          </h1>
          
          <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-400">
            <Link to="/book">
              <Button size="lg" className="h-14 px-8 text-lg bg-blue-600 hover:bg-blue-700 rounded-full shadow-xl shadow-blue-200 group">
                Book Now 
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Button variant="outline" size="lg" className="h-14 px-8 text-lg rounded-full border-gray-200 hover:bg-gray-50">
              View Our Doctors
            </Button>
          </div>
          ...
          <div className="mt-20 relative mx-auto max-w-5xl animate-in fade-in zoom-in duration-1000 delay-500">
            <div className="relative rounded-3xl overflow-hidden glass p-4 group">
              <div className="aspect-[16/9] rounded-2xl flex items-center justify-center relative overflow-hidden bg-white/50">
                <img 
                ...
                <div className="absolute top-10 left-10 p-4 bg-white/90 backdrop-blur-md rounded-2xl shadow-lg border border-white flex items-center gap-3 animate-float">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm font-bold text-gray-900">100% HIPAA Compliant</p>
                  </div>
                </div>
      ...
      <section id="how-it-works" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600">Getting expert care is simple and fast</p>
          </div>

          <div className="grid md:grid-cols-4 gap-12 relative">
            {/* Connecting Lines (Desktop) */}
            <div className="hidden md:block absolute top-1/2 left-1/3 right-1/3 h-0.5 border-t-2 border-dashed border-blue-100 -translate-y-1/2 -z-0" />
            ...
            {[
              ...
              <div key={i} className="relative z-10 bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50 transition-all group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              ...
              <p className="text-gray-600 max-w-xl">We provide comprehensive healthcare solutions tailored to your unique requirements.</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-6 bg-white rounded-3xl border border-gray-100 hover:border-blue-500/30 hover:shadow-lg transition-all group cursor-pointer">
                <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-600 rounded-[2.5rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-200">
            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-indigo-900/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
              <Link to="/register">
                <Button size="lg" className="h-14 px-10 bg-white text-blue-600 hover:bg-gray-100 rounded-full font-bold">
                  Get Started for Free
                </Button>
              </Link>
              <Link to="/book">
                <Button size="lg" className="h-14 px-10 bg-blue-700 text-white hover:bg-blue-800 rounded-full border-none">
                  Book Appointment
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">NovaCare Clinic</span>
            </div>
